...
function LoginForm() {
  ...
  useEffect(() => {
    if (searchParams.get("registered") === "true") {
      setSuccess("Account registered successfully! Please log in below.");
    }
  }, [searchParams]);
...
export default function Login() {
  return (
    <div className="auth-wrapper animate-fade-in">
      ...
      <Suspense fallback={<div className="glass-card" style={{ padding: 40, width: 460, textAlign: "center" }}><Loader2 className="animate-spin" style={{ margin: "0 auto 10px" }} />Loading...</div>}>
        <LoginForm />
      </Suspense>
